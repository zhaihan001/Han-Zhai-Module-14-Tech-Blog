...
This is the application that developers can publish their blog posts and comment on other developers’ posts as well.
...
- Create a .env file with following lines of info in root folder. And fill up with your db username and password.
- DB_NAME='blog_db'
  DB_USER=''
  DB_PASSWORD=''

- Run 'nodemon start'
- Browse to localhost:3001/ from your browser
...
- For more projects, please visit my [GitHub](https://github.com/zhaihan001).
